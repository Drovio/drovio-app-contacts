...
$contactListContainer = HTML::select(".test-messaging-application .contact-list-container")->item(0);

$form = new simpleForm();
$contactListForm = $form->build("", false);
$contactListForm->engageApp("chat");
